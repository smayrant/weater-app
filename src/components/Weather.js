...
const Weather = props => (
    <div className="weather-div">
        ...
        {props.temperature && <p className="weather-key">Temperature: <span className="weather-value">{props.temperature} F</span></p>}
        ...
        {props.error && <h3><span className="error-msg">{props.error}!</span></h3>}
    </div>
)
